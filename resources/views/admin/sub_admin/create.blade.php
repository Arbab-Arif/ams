            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                <div class="intro-y box">
                    ...
                    <div class="p-5" id="form-validation">
                        <div class="preview">
                            <form method="post" action="{{ route('admin.sub_admin.store') }}">
                                @csrf
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2">
                                    ...
                                    <div class="w-full md:w-1/2 px-3 mb-6 mt-4 md:mb-0">
                                        ...
                                        <input type="password" name="password"
                                               class="cols-3 input w-full border mt-2 @error('password') border-red-400 @enderror"
                                               placeholder="Enter Password" minlength="2" value="{{ old('password') }}">
                                    </div>
                                </div>
