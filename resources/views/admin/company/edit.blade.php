                        ...
                        <div class="preview">
                            ...
                            <form method="post" action="{{ route('admin.company.update', $company) }}">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input type="text" name="name" id="name"
                                               ...
                                               placeholder="Enter Name" minlength="2" value="{{ $company->name }}">
                                    </div>
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        <label
                                        ...
                                        <select data-search="true" class="tail-select w-full
                                            ...
                                            <option value="fixed" @if($company->type == 'fixed') selected @endif>Fixed</option>
                                            <option value="flexible" @if($company->type == 'flexible') selected @endif>Flexible</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="w-full md:w-1/2 px-3 pl-0 mt-6 mb-6 md:mb-0" id="flexible"
                                     @if($company->type !== 'flexible') style="display: none" @endif>
                                    <label
                                        class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                        for="name">
                                        Hours
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2" id="fixed"
                                     @if($company->type !== 'fixed')  style="display: none" @endif>
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
...
{{--                                <div class="flex flex-wrap -mx-3 mb-2" id="time"--}}
{{--                                    @if($company->time_in == '' || $company->time_out == '') style="display: none" @endif>--}}
{{--                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">--}}
{{--                                        <label--}}
{{--                                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"--}}
{{--                                            for="name">--}}
