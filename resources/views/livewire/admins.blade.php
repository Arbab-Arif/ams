                                ...
                                <table class="table">
                                    ...
                                    @foreach($admins as $key => $admin)
                                        <tr>
                                            ...
                                            <td class="border-b whitespace-no-wrap">{{ $admin->name }}</td>
                                            <td class="border-b whitespace-no-wrap">{{ $admin->email }}</td>
                                            <td class="border-b whitespace-no-wrap">{{ $admin->contact }}</td>
                                            <td class="border-b whitespace-no-wrap">
                                                <a href="{{ route('admin.sub_admin.edit', $admin->id) }}">
